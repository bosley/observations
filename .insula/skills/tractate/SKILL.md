...
- Do not reprint a proposition. Cite the number and write the new job. Opening with another number's wording is the failure, even with a cite after it. "A gap is not, by itself, a lie" is the specimen. The thought lives at 5.17 and 5.11. Later integers do not get the sentence.
