...
graph TD
  subgraph substrate [Substrate]
    mind["mind (1.0)"]
    recall["recall (1.61)"]
    imprint["imprint (1.62)"]
    modalities["two modalities of memory (1.64)"]
    physicalRemnant["physical remnant (3.2)"]
    socialRemnant["social remnant (3.3)"]
    bone["bone (4.01)"]
    softSystem["soft system (4.02)"]
  end

  subgraph reading [Record and reading]
    principality["principality (4.31)"]
    hardenedRecord["hardened record (5.14)"]
    authenticity["authenticity (5.17)"]
    fourErrors["the four errors (7.1-7.4)"]
    contactError["contact error (7.1)"]
    readerError["reader error (7.2)"]
    observer["observer (7.5)"]
  end

  subgraph selfhood [Self]
    self["self (6.0)"]
    standard["standard (6.14)"]
    ideal["ideal (6.16)"]
    authenticSelf["authentic self (6.2)"]
    defaultOrder["default order (6.17)"]
    mitigation["mitigation (8.21)"]
  end

  subgraph landscape [Landscape]
    weight["weight (9.0)"]
    emotionalLandscape["emotional landscape (9.1)"]
    singularity["singularity (9.13)"]
    flameFathom["flame / fathom (10.12, 10.2)"]
  end

  subgraph ground [Ground]
    primordiant["Primordiant (11.41)"]
    etch["etch (12.121)"]
    install432["repetition / consequence (4.32)"]
  end
  ...
  modalities --> imprint
  recall --> mind
  physicalRemnant --> recall
  socialRemnant --> imprint
  bone --> physicalRemnant
  softSystem --> socialRemnant
  softSystem --> imprint
  principality --> softSystem
  hardenedRecord --> bone
  hardenedRecord --> physicalRemnant
  authenticity --> hardenedRecord
  self --> mind
  self --> modalities
  standard --> principality
  ideal --> standard
  authenticSelf --> authenticity
  authenticSelf --> self
  authenticSelf --> ideal
  authenticSelf --> hardenedRecord
  fourErrors --> modalities
  fourErrors --> physicalRemnant
  fourErrors --> principality
  observer --> contactError
  observer --> readerError
  observer --> principality
  mitigation --> defaultOrder
  weight --> softSystem
  singularity --> emotionalLandscape
  flameFathom --> softSystem
  primordiant --> flameFathom
  etch --> flameFathom
  etch --> install432
```
...
graph TD
  ...
  recall["recall (1.61, 1.64)"]
  imprint["imprint (1.61, 1.62, 1.64)"]
  modalities["two modalities of memory (1.64)"]
  theI["I (1.64)"]
  communication["communication (2.1)"]
  worldview["worldview (2.3)"]
  physicalRemnant["physical remnant (3.2)"]
  socialRemnant["social remnant (3.3)"]
  history["history (3.5)"]
  ...
  physicalRemnant --> recall
  socialRemnant --> imprint
  socialRemnant --> communication
  history --> physicalRemnant
  history --> socialRemnant
  history --> modalities
  history --> mind
```
...
```mermaid
graph TD
  physicalRemnant32["physical remnant (3.2)"]
  socialRemnant33["social remnant (3.3)"]
  imprint162["imprint (1.62)"]
  bone["bone (4.01)"]
  softSystem["soft system (4.02)"]
  principality["principality (4.31)"]
  nesting["nesting (4.33)"]
  scaleLikeness["scale likeness (4.34)"]
  likenessAsIdentity["likeness taken as identity (4.341)"]

  bone --> physicalRemnant32
  softSystem --> socialRemnant33
  softSystem --> imprint162
  principality --> softSystem
  principality --> bone
  nesting --> principality
  scaleLikeness --> nesting
  likenessAsIdentity --> scaleLikeness
```
...
graph TD
  gap["the gap (5.0)"]
  representation["representation of another mind (5.02)"]
  record["record (5.03)"]
  intentionAttribution["intention attribution (5.11)"]
  hardenedRecord["hardened record (5.14, 5.141)"]
  fruits["fruits (5.15, 5.151)"]
  fairRepresentative["fair representative (5.151)"]
  foregrounding["foregrounding (5.152)"]
  authenticity["authenticity (5.17)"]
  physicalRemnant32["physical remnant (3.2)"]
  bone401["bone (4.01)"]
  principality431["principality (4.31)"]
  worldview23["worldview (2.3)"]
  environment13["environment (1.3)"]

  gap --> environment13
  representation --> gap
  representation --> worldview23
  record --> physicalRemnant32
  record --> bone401
  record --> representation
  intentionAttribution --> representation
  hardenedRecord --> record
  hardenedRecord --> physicalRemnant32
  hardenedRecord --> bone401
  fruits --> hardenedRecord
  fruits --> principality431
  fairRepresentative --> fruits
  fairRepresentative --> principality431
  foregrounding --> fairRepresentative
  authenticity --> hardenedRecord
```
...
graph TD
  ...
  ideal["ideal (6.16)"]
  defaultOrder["default order (6.17)"]
  authenticSelf["authentic self (6.2, 6.22)"]
  consistentSelf["consistent self (6.3)"]
  fairness["fairness (6.5)"]
  mind10["mind (1.0)"]
  modalities164["two modalities of memory (1.64)"]
  authenticity517["authenticity (5.17)"]
  hardenedRecord514["hardened record (5.14)"]
  fairRep5151["fair representative (5.151)"]
  foregrounding5152["foregrounding (5.152)"]
  nesting433["nesting (4.33)"]

  self --> mind10
  self --> modalities164
  role --> fairRep5151
  role --> foregrounding5152
  standard --> role
  standard --> fairRep5151
  ideal --> standard
  defaultOrder --> nesting433
  authenticSelf --> authenticity517
  authenticSelf --> self
  authenticSelf --> ideal
  authenticSelf --> hardenedRecord514
  consistentSelf --> defaultOrder
  fairness --> fairRep5151
  fairness --> ideal
```
...
graph TD
  contactError["contact error (7.1)"]
  readerError["reader error (7.2)"]
  inscriptionError["inscription error (7.3)"]
  scaleError["scale error (7.4)"]
  observer["observer (7.5)"]
  gap50["the gap (5.0)"]
  history35["history (3.5)"]
  record503["record (5.03)"]
  communication22["communication (2.2, 2.3)"]
  remnants36["social remnant / assumptions (3.6)"]
  modalities164["two modalities of memory (1.64)"]
  imprint161["imprint (1.61, 1.62)"]
  scaleLikeness434["scale likeness (4.34)"]
  principality431["principality (4.31)"]

  contactError --> gap50
  contactError --> history35
  contactError --> record503
  readerError --> communication22
  readerError --> remnants36
  inscriptionError --> modalities164
  inscriptionError --> imprint161
  scaleError --> scaleLikeness434
  scaleError --> principality431
  observer --> contactError
  observer --> readerError
  observer --> principality431
```
...
graph TD
  mitigation["mitigation (8.21)"]
  chosen["chosen (8.22, 8.23)"]
  placed["placed (8.22, 8.23)"]
  defaultOrder617["default order (6.17)"]
  foregrounding5152["foregrounding (5.152)"]
  communication22["communication (2.2)"]
  observer75["observer (7.5)"]
  scaleError74["scale error (7.4)"]
  shaping611["self being shaped (6.11)"]

  mitigation --> defaultOrder617
  mitigation --> shaping611
  chosen --> foregrounding5152
  placed --> foregrounding5152
  placed --> communication22
  chosen --> observer75
  placed --> observer75
  chosen --> scaleError74
  placed --> scaleError74
...
```mermaid
graph TD
  weight["weight (9.0, 9.01)"]
  emotionalLandscape["emotional landscape (9.1)"]
  uncreatedTerritory["uncreated territory (9.11)"]
  gravityLikeness["gravity likeness (9.12)"]
  singularity["singularity (9.13)"]
  boundary["boundary (9.3, 10.22)"]
  softSystem402["soft system (4.02)"]
  imprint432["imprint / conditioning (4.32)"]
  inscriptionError73["inscription error (7.3)"]
  communication21["communication (2.1, 2.2)"]
  flame102["flame (10.2)"]

  weight --> softSystem402
  weight --> imprint432
  weight --> inscriptionError73
  emotionalLandscape --> communication21
  uncreatedTerritory --> emotionalLandscape
  gravityLikeness --> weight
  gravityLikeness --> emotionalLandscape
  singularity --> gravityLikeness
  singularity --> weight
  boundary --> emotionalLandscape
  boundary --> flame102
```
...
```mermaid
graph TD
  momentariness["momentariness (10.1)"]
  flame["flame (10.12, 10.2)"]
  fathom["fathom (10.12, 10.14)"]
  boundary["boundary (9.3, 10.22)"]
  death["death (13.0)"]
  fade["fade (13.01)"]
  finalSingularity["final singularity (13.12)"]
  softSystem402["soft system (4.02)"]
  bone401["bone (4.01)"]
  singularity913["singularity (9.13)"]
  theI164["I (1.64)"]

  momentariness --> theI164
  flame --> softSystem402
  fathom --> flame
  fathom --> momentariness
  boundary --> flame
  death --> softSystem402
  death --> bone401
  fade --> death
  fade --> bone401
  finalSingularity --> singularity913
  finalSingularity --> fathom
  finalSingularity --> fade
```
...
graph TD
  subgraph ground [Ground]
    primordiant["Primordiant (11.41, 11.411, 11.412)"]
    form["form (12.0)"]
    relation["relation (12.1)"]
    resolution["resolution (12.01)"]
    etch["etch (12.121)"]
  end

  subgraph shade [Light and shade]
    degreesOfFalsehood["degrees of falsehood (12.21)"]
    light["light (12.22)"]
    shadeNode["shade (12.22)"]
    evil["evil (12.23)"]
    suffering["suffering (12.23)"]
    happenstanceShade["happenstance shade (12.32)"]
    infliction["infliction (12.33)"]
    night["night (12.341)"]
    darkness["darkness (12.341)"]
  end

  subgraph willAndFigures [Will and figures]
    freeWill["free will (14.0, 14.01)"]
    degreesOfFreedom["degrees of freedom (14.1, 14.11)"]
    analogy["analogy (15.0)"]
    metaphor["metaphor (15.1)"]
    allegory["allegory (15.2)"]
  end

  fathom1012["fathom (10.12)"]
  flame102["flame (10.2)"]
  contactError71["contact error (7.1)"]
  readerError72["reader error (7.2)"]
  scaleError74["scale error (7.4)"]
  principality432["repetition / consequence (4.32)"]
  authenticSelf622["authentic self (6.22)"]
  choosing82["choosing (8.2)"]
  weight912["weight / gravity likeness (9.12)"]
  grouping1121["grouping (11.21)"]

  primordiant --> fathom1012
  primordiant --> flame102
  form --> grouping1121
  form --> relation
  relation --> contactError71
  relation --> readerError72
  resolution --> form
  resolution --> grouping1121
  etch --> relation
  etch --> fathom1012
  etch --> principality432
  degreesOfFalsehood --> contactError71
  degreesOfFalsehood --> readerError72
  degreesOfFalsehood --> scaleError74
  light --> form
  shadeNode --> light
  evil --> shadeNode
  suffering --> evil
  happenstanceShade --> form
  happenstanceShade --> shadeNode
  infliction --> happenstanceShade
  infliction --> choosing82
  infliction --> primordiant
  night --> evil
  darkness --> form
  freeWill --> weight912
  freeWill --> degreesOfFalsehood
  degreesOfFreedom --> authenticSelf622
  degreesOfFreedom --> resolution
  degreesOfFreedom --> freeWill
  metaphor --> fathom1012
  metaphor --> flame102
  allegory --> form
  allegory --> fathom1012
