...
**5.01** There exist stories of people who could do this. They don't seem to map to reality. But the fact that such stories exist at all is itself evidence for 5.0 — a limit doesn't generate myths about its own absence unless it is felt, repeatedly, as friction. The stories are a symptom of the gap, not a counterexample to it.
...
**5.1** Since stories can be told that don't map to reality, as 5.01 already shows, we have to assume that all stories we've ever been told may contain some degree of error.
...
**5.12** If minds can be doubted, then the stories those minds produce must be doubted for the same reason: a story is just communication in 2.1's sense, carrying the assumptions 2.2 and 2.3 already describe as structurally embedded before anyone stops to examine them.
...
**6.04** By 5.151 I am not a mind sitting apart from the principalities I belong to. I am a piece of fruit by which each of them is known, whenever membership is foregrounded (5.152). The self in 6.0 is a mind occupying a set of roles, not a mind alone with its habits.

**6.05** A role, here, is what 5.151 already named without naming it: the concept of a principality as another mind holds it when it looks at me, in the situations where that membership is under scrutiny (5.152).

**6.1** Apply 5.17 to the self: an authentic self is one whose story of itself stays close to its own hardened record.

**6.11** 5.17's authenticity is a comparison made at a moment, story checked once against record. 4.32 already showed the soft system does not hold still. It keeps organizing whatever happens next along lines laid down earlier, whether I am aware of it or not. A self is being written even while it is being checked.
...
**6.14** Every role from 6.04–6.05 carries an implicit measure for what counts as carrying it out well. That is what 5.151 already located when it said fairness is the one part still mine to choose. Call that measure, for any given role, its standard.
...
**6.2** Authentic self is a mind doing three things at once. Reading its own hardened record honestly against the story it tells (6.1–6.12). Setting rather than merely inheriting the order of standards it is checked against (6.16–6.17). Acting to close whatever gap the reading in 6.12 turns up between the two.
...
**6.22** So "authentic self" does not mean a self that has reached its ideal. It means a self currently doing both halves of 6.2: refining what it knows about itself, and refining what it holds itself to, with nothing but its own record as the check on either.

**6.3** This separates authenticity from mere consistency. A self can match its own record perfectly, in the sense 6.1 asks for, while never having set anything by 6.16 at all, simply reporting, accurately, the shape supplied by 6.17's default. That self is consistent. 6.22 does not call it authentic.

**6.31** The reverse failure is just as available. A self can set a clearly examined standard for every role by 6.16, and still be inauthentic if the record in 6.12 shows no movement toward it. An ideal that never enters the record is a story about a self. 5.17 already ruled on what a story that has come apart from the record amounts to.

**6.4** Because 6.04 already placed the self inside its principalities as one of their fruits, none of this refining stays private. Whatever a role is refined toward, well or badly, becomes part of what 5.16 calls the record by which the principality gets checked against its own account of itself.
